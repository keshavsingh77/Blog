...
export const INITIAL_POSTS: Post[] = [
  ...
  },
  {
    ...
    tags: ['Social Media', 'Instagram', 'Growth', 'Viral'],
    status: PostStatus.PUBLISHED,
  ...
  },
  {
    ...
    category: Category.TECH,
    tags: ['Editing', 'Mobile', 'YouTube Shorts', 'AI'],
    status: PostStatus.PUBLISHED,
  ...
  },
  {
    ...
    category: Category.TECH,
    tags: ['AI', 'Tools', 'Productivity', 'Future'],
    status: PostStatus.PUBLISHED,
  ...
  },
  {
    ...
    tags: ['Mobile', 'Hardware', 'Gaming', 'Android'],
    status: PostStatus.PUBLISHED,
