...
export const INITIAL_POSTS: Post[] = [
  ...
  {
    id: '4',
    title: 'Top 5 Secret Productivity Tools That Feel Illegal To Know',
    content: '<p>Technology is moving fast. These 5 tools can automate your work, write your emails, and even edit your videos automatically. Use them wisely!</p><p>From automated coding assistants to workflow enhancers, explore the cutting edge of productivity.</p>',
    category: 'Tech',
    tags: ['Tools', 'Productivity', 'Future', 'Tech'],
    status: PostStatus.PUBLISHED,
