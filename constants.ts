...
export const INITIAL_POSTS: Post[] = [
  {
    ...
    tags: ['Earning', 'Apps', 'Finance', 'UPI', 'Earn Money Online', 'Bot'],
  ...
  },
  {
    ...
    tags: ['Social Media', 'Instagram', 'Growth', 'Viral', 'Free Followers', 'Psychology'],
    status: PostStatus.PUBLISHED,
  ...
  },
  {
    ...
    category: Category.TECH,
    tags: ['Editing', 'Mobile', 'YouTube Shorts', 'AI', 'CapCut', 'Image to Video'],
    status: PostStatus.PUBLISHED,
  ...
  },
  {
    ...
    tags: ['Mobile', 'Hardware', 'Gaming', 'Android', 'Blogger'],
    status: PostStatus.PUBLISHED,
